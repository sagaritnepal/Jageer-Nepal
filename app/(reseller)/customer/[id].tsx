...
function EditableDetails({ customerId }: { customerId: string }) {
...
function AddEntryForm({ customerId, reselerId, onDone }: { customerId: string; reselerId: string; onDone: () => void }) {
...
export default function CustomerDetailScreen() {
  ...
  return (
    <ScrollView className="flex-1 bg-gray-50 px-6 pt-4" contentContainerStyle={{ paddingBottom: 40 }}>
      ...
      {showAddEntry && <AddEntryForm customerId={id} reselerId={userId} onDone={() => setShowAddEntry(false)} />}
